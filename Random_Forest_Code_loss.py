...
cols1 = ["om","yr","mo","dy","tz","stf","stn","mag","inj","fat","loss","closs","slat","slon","elat","elon","len","wid","fc"]
Tornadoes_data = Tornadoes_data1.filter(cols1, axis = 1)

# Labels are the values we want to predict
labels = np.array(Tornadoes_data['loss'])
# Remove the labels from the features
# axis 1 refers to the columns
features= Tornadoes_data.drop('loss', axis = 1)
# Saving feature names for later use
feature_list = list(Tornadoes_data.columns)
features_list2 = list(Tornadoes_data.drop('loss', axis = 1).columns)
...
print(scaler.transform(train_labels))

scale_train_labels = scaler.transform(train_labels)
# [[-1.]
#  [-1.]
#  [ 1.]
#  [ 1.]]
...
print(scaler.transform(test_labels))

scale_test_labels = scaler.transform(test_labels)
# [[2.]]
